...
export function SiteHeader(): React.JSX.Element {
  return (
    <header className="mx-auto flex max-w-6xl items-center justify-between px-4 pb-2 pt-6">
      <div className="flex items-baseline gap-2">
        <span className="text-xl font-bold tracking-tight">
          f1<span className="text-[color:var(--accent)]">·</span>pitwall
        </span>
        <span className="text-sm text-[color:var(--muted)]">race replay &amp; predictions</span>
      </div>
